            ...
            <div className="space-y-6">
                ...
                <div>
                    <div className="flex items-center gap-2 text-xs font-medium text-gray-500 mb-1">
                        ...
                        <span>&rsaquo;</span>
                        <span className="text-gray-800 font-semibold">Rekam Medis Elektronik</span>
                    </div>

                    {/* <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <h1 className="text-2xl md:text-3xl font-serif font-bold text-[#145e5b] tracking-tight">
                                Rekam Medis Elektronik (RME)
                            </h1>
                            <p className="mt-1 text-xs md:text-sm text-gray-500">
                                Monitoring vital signs pasien, pencatatan rekam medis dokter &amp; perawat, serta penerbitan dan penebusan resep digital.
                            </p>
                        </div>
                    </div> */}
                </div>
