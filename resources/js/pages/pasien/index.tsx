...
export default function PasienIndex({
    ...
    const [asuransiFilter, setAsuransiFilter] = useState(
        filters.asuransi ?? '',
    );
    ...
    const totalDataCount =
        (patients as any)?.total ?? totalCount ?? patientData.length;
    const fromCount =
        (patients as any)?.from ?? (patientData.length > 0 ? 1 : 0);
    ...
    return (
        <Layout user={user} role={role}>
            ...
            {/* Top Breadcrumb */}
            <nav className="mb-2 flex text-xs font-medium text-gray-500">
                <span>Dashboard</span>
            ...
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                <div>
                    <h1 className="font-serif text-3xl font-bold text-[#145e5b]">
                        Manajemen Pasien
                    </h1>
                    <p className="mt-1 text-xs text-gray-500">
                        Total {totalDataCount.toLocaleString('id-ID')} pasien
                        terdaftar
                    </p>
                </div>
            ...
            <div className="rounded-xl border border-gray-200/80 bg-white p-4 shadow-2xs">
                ...
                >
                    ...
                    <div className="min-w-[240px] flex-1">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-gray-300 bg-white py-2 pr-3 pl-9 text-xs text-gray-900 placeholder:text-gray-400 focus:border-[#145e5b] focus:outline-none"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 pt-2 sm:pt-0">
                        ...
                        <button
                            type="submit"
                            className="rounded-lg bg-[#72d6c9] px-4 py-2 text-xs font-semibold text-teal-950 shadow-2xs transition hover:bg-[#5ec4b7]"
                        >
                            Terapkan Filter
                        </button>
                        <button
                            ...
                            className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg border border-[#145e5b] bg-white px-4 py-2 text-xs font-semibold text-[#145e5b] transition hover:bg-[#f0faf7]"
                        >
                            <svg
                                className="h-4 w-4"
                                fill="none"
            ...
            <div className="overflow-x-auto rounded-xl border border-gray-200/80 bg-white shadow-2xs">
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {patientData.length === 0 ? (
                            ...
                            patientData.map((p: any, idx: number) => (
                                <tr
                                    key={p.id || idx}
                                    className="transition-colors hover:bg-[#f7fcfb]"
                                >
                                    ...
                                    <td className="p-4">
                                        <div className="flex items-center justify-center gap-2">
                                            ...
                                            <button
                                                ...
                                                className="rounded-md p-1.5 text-gray-500 transition hover:bg-[#e4f6f2] hover:text-[#145e5b]"
                                                title="Detail Pasien"
                                            >
                                                <svg
                                                    className="h-4 w-4"
                                            ...
                                            <button
                                                ...
                                                className="rounded-md p-1.5 text-gray-500 transition hover:bg-rose-50 hover:text-rose-600"
                                                title="Hapus Pasien"
                                            >
                                                <svg
                                                    className="h-4 w-4"
                ...
                <div className="flex flex-col items-center justify-between gap-3 border-t border-gray-100 px-4 py-3 text-xs text-gray-600 sm:flex-row">
                    <div>
                        Menampilkan {fromCount} - {toCount} dari{' '}
                        {totalDataCount.toLocaleString('id-ID')} data
                    </div>
                    ...
                    <div className="flex items-center gap-1">
                        {paginationLinks.length > 0 ? (
                            ...
                            <>
                                <span className="rounded-md px-2.5 py-1 text-gray-400">
                                    &lt;
                                </span>
                                <span className="rounded-md bg-[#145e5b] px-3 py-1 font-bold text-white shadow-2xs">
                                    1
                                </span>
                                <span className="rounded-md px-2.5 py-1 text-gray-400">
                                    &gt;
