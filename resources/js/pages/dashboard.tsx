...
export default function Dashboard({
    ...
    const currentWeeklyVisits =
        weeklyVisits && weeklyVisits.length > 0 ? weeklyVisits : [];
    const maxVisitCount = Math.max(
        ...currentWeeklyVisits.map((v) => v.count),
        1,
    );
    ...
    const activeDayData =
        currentWeeklyVisits.find((v) => v.day === selectedDay) ||
        currentWeeklyVisits[0];
    ...
    const AdminDashboard = () => (
        <div className="space-y-6">
            ...
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                <div>
                    <h1 className="font-serif text-3xl font-bold tracking-tight text-[#0d4f42]">
                        Dashboard Admin
                    </h1>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    <div className="flex items-start justify-between">
                        ...
                        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#e4f6f2] text-[#0d4f42] transition-colors group-hover:bg-[#145e5b] group-hover:text-white">
                            <svg
                                className="h-4 w-4"
                                fill="none"
                                viewBox="0 0 24 24"
                    ...
                    <div className="mt-4">
                        ...
                        <div className="mt-1.5 flex items-center gap-1.5 text-xs font-semibold text-[#0d4f42]">
                            ...
                            <span>
                                {stats?.patientTrend ?? 'Belum ada data'}
                            </span>
                        </div>
                    </div>
                </Link>
                ...
                >
                    ...
                    <div className="mt-4">
                        ...
                        <div className="mt-1.5 flex items-center gap-1.5 text-xs font-semibold text-rose-600">
                            ...
                            <span>
                                {stats?.appointmentTrend ?? 'Belum ada data'}
                            </span>
                        </div>
                    </div>
                </Link>
                ...
                >
                    ...
                    <div className="mt-4">
                        ...
                        <div className="mt-1.5 flex items-center gap-1.5 text-xs font-semibold text-[#0d4f42]">
                            ...
                            <span>
                                {stats?.revenueTrend ?? 'Belum ada data'}
                            </span>
                        </div>
                    </div>
                </Link>
                ...
                >
                    ...
                    <div className="mt-4">
                        ...
                        <div className="mt-1.5 flex items-center gap-1.5 text-xs font-semibold text-gray-500">
                            <span>→</span>
                            <span>
                                {stats?.doctorTrend ?? 'Belum ada data'}
                            </span>
                        </div>
                    </div>
                </Link>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                ...
                <div className="flex flex-col justify-between rounded-2xl border border-gray-100 bg-white p-6 shadow-xs lg:col-span-8">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 rounded-full bg-[#e4f6f2] px-3.5 py-1.5 text-xs font-semibold text-[#0d4f42] transition-colors hover:bg-[#d5f0ea]"
                            >
                            ...
                            {showRangeDropdown && (
                                <div className="absolute top-full right-0 z-20 mt-1 w-40 rounded-xl border border-gray-200 bg-white py-1 text-xs shadow-lg">
                                    {[
                                        '7 Hari Terakhir',
                                        '14 Hari Terakhir',
                                        'Bulan Ini',
                                        ...
                                        <button
                                            ...
                                            className={`block w-full px-3 py-1.5 text-left font-medium ${chartRange === opt ? 'bg-teal-50 font-bold text-[#0d4f42]' : 'text-gray-700 hover:bg-gray-50'}`}
                                        >
                                            {opt}
                                        </button>
                                    ))}
                    ...
                    <div className="mt-8">
                        <div className="flex h-48 items-end justify-between gap-3 border-b border-gray-100 px-2 pb-2 sm:gap-6">
                            {currentWeeklyVisits.map((item, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="pointer-events-none absolute -top-12 z-20 hidden rounded-lg bg-gray-900 px-2.5 py-1 text-[11px] font-semibold whitespace-nowrap text-white shadow-md group-hover:block">
                                            {item.fullName}:{' '}
                        ...
                        {activeDayData && (
                            <div className="mt-4 flex flex-wrap items-center justify-between gap-2 rounded-xl bg-[#f0faf7] p-3 text-xs text-[#0d4f42]">
                                <div className="font-semibold">
                                    📊 Kunjungan {activeDayData.fullName}:{' '}
                                    <span className="font-bold">
                                        {activeDayData.count} Pasien
                                    </span>
                                </div>
                                <div className="flex items-center gap-4 text-[11px] text-gray-600">
                                    <span>
                                        Rawat Jalan:{' '}
                                        <b>
                                            {activeDayData.rawatJalan ||
                                                Math.round(
                                                    activeDayData.count * 0.7,
                                                )}
                                        </b>
                                    </span>
                                    <span>
                                    ...
                                    <span>
                                        Rawat Inap:{' '}
                                        <b>
                                            {activeDayData.rawatInap ||
                                                Math.round(
                                                    activeDayData.count * 0.1,
                                                )}
                                        </b>
                                    </span>
                                </div>
                    ...
                    <div className="flex-1 space-y-6">
                        {currentActivities.slice(0, 4).map((act, idx) => (
                            ...
                            >
                                ...
                                {idx !==
                                    currentActivities.slice(0, 4).length -
                                        1 && (
    ...
    const BillingDashboard = () => {
        const [invoices, setInvoices] =
            useState<KasirTagihanItem[]>(kasirInvoices);
        ...
        const [rincianItems, setRincianItems] = useState<KasirRincianItem[]>([
            {
                ...
                desc: 'Pemeriksaan rutin spesialis',
                price: 150000,
                qty: 1,
                total: 150000,
                icon: 'stethoscope',
            ...
            {
                label: 'Pemeriksaan Lab / Alkes',
                desc: 'Cek sampel & tes diagnostik',
                price: 100000,
                qty: 1,
                total: 100000,
                icon: 'vial',
        ...
        const enteredNominal =
            parseInt(nominalInput.replace(/\D/g, ''), 10) || 0;
        ...
        const filteredInvoices = invoices.filter((inv) => {
            const matchSearch =
                ...
                (inv.no_rm &&
                    inv.no_rm.toLowerCase().includes(search.toLowerCase()));
        ...
        const handleProcessPayment = async () => {
            ...
            if (
                ...
                enteredNominal > 0 &&
                enteredNominal < totalAmount
            ) {
                setToastMessage(
                    `Nominal pembayaran tunai kurang dari total tagihan (${formatRupiah(totalAmount)}).`,
                );
            ...
            const payAmount =
                selectedPaymentMethod === 'Tunai' && enteredNominal > 0
                    ? enteredNominal
                    : totalAmount;
            ...
            try {
                const response = await fetch(
                    `/api/v1/tagihan/${selectedInvoice.id}/bayar`,
                    {
                        method: 'POST',
                        headers: {
                ...
                if (response.ok && resData.status === 'success') {
                    ...
                    setToastMessage(
                        `Pembayaran invoice ${selectedInvoice.no_invoice} BERHASIL DIPROSES!`,
                    );
                    setShowReceiptModal(true);
                } else {
                    setToastMessage(
                        resData.message || 'Gagal memproses pembayaran.',
                    );
                }
            } catch (err) {
        ...
        const handleCreateInvoice = async (e: React.FormEvent) => {
            ...
            const targetPasienId =
                selectedPasienId ||
                (kasirPatientsList.length > 0 ? kasirPatientsList[0].id : null);
            if (!targetPasienId) {
            ...
            try {
                ...
                if (response.ok && resData.status === 'success') {
                    ...
                    setInvoices((prev) => [
                        {
                            ...
                            nama_pasien:
                                newInv.pasien?.nama_lengkap || 'Pasien Baru',
                    ...
                    setToastMessage(
                        `Invoice ${newInv.no_invoice} berhasil dibuat!`,
                    );
                    setTimeout(() => setToastMessage(null), 3000);
                } else {
        ...
        return (
            <div className="space-y-6">
                {/* Notification Toast */}
                {toastMessage && (
                    <div className="fixed top-5 right-5 z-50 flex animate-bounce items-center gap-3 rounded-2xl bg-emerald-800 px-5 py-3 text-sm font-bold text-white shadow-xl">
                        <svg
                ...
                <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            Kelola transaksi pembayaran, invoice, dan pencetakan
                            kuitansi pasien real-time.
                        </p>
                    </div>
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-xl bg-[#0d4f42] px-4 py-2.5 text-xs font-bold text-white shadow-xs transition-all hover:bg-[#08382f]"
                        >
                            <svg
                                className="h-4 w-4"
                                fill="none"
                    ...
                    <div className="flex flex-col justify-between rounded-2xl border border-gray-100 bg-white p-5 shadow-xs">
                        ...
                        <div className="mt-3">
                            <div className="text-2xl font-extrabold tracking-tight text-gray-900">
                                {formatRupiah(
                                    totalPendapatanToday || kasirTodayRevenue,
                                )}
                            </div>
                    ...
                    <div className="flex flex-col justify-between rounded-2xl border border-gray-100 bg-white p-5 shadow-xs">
                        ...
                        <div className="mt-3">
                            ...
                            <div className="mt-1 text-xs font-medium text-rose-600">
                                Total:{' '}
                                {formatRupiah(
                                    pendingAmount || kasirPendingAmount,
                                )}
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-col items-center justify-between gap-3 rounded-2xl border border-gray-100 bg-white p-4 shadow-xs sm:flex-row">
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xs lg:col-span-2">
                        <div className="flex items-center justify-between border-b border-gray-100 bg-gray-50/50 p-4">
                            ...
                            <span className="text-xs font-medium text-gray-400">
                                Klik baris untuk melihat rincian & memproses
                            </span>
                        </div>
                                                ...
                                                <tr
                                                    ...
                                                    className={`cursor-pointer transition-all ${
                                                        isSelected
                                                            ...
                                                            : 'text-gray-800 hover:bg-teal-50/40'
                                                    }`}
                                                >
                    ...
                    {selectedInvoice ? (
                        <div className="flex h-fit flex-col justify-between space-y-5 rounded-2xl border border-gray-100 bg-white p-6 shadow-xs">
                            <div>
                                <div className="mb-4 flex items-start justify-between border-b border-gray-100 pb-3">
                                    <div>
                                        ...
                                        <h2 className="mt-0.5 text-xl font-bold tracking-tight text-[#0d4f42]">
                                            {selectedInvoice.no_invoice}
                                        </h2>
                                        <p className="text-xs font-semibold text-gray-800">
                                            {selectedInvoice.nama_pasien}{' '}
                                            <span className="font-normal text-gray-400">
                                                ({selectedInvoice.layanan})
                                            </span>
                                        </p>
                                    </div>
                                    <span
                                ...
                                <div className="max-h-60 space-y-3.5 overflow-y-auto pr-1">
                                    {selectedInvoice.rincian &&
                                    selectedInvoice.rincian.length > 0 ? (
                                        selectedInvoice.rincian.map(
                                            (item, idx) => (
                                                <div
                                                    key={idx}
                                        ...
                                        <p className="text-xs text-gray-400 italic">
                                            Rincian item layanan tidak tersedia.
                                        </p>
                                    )}
                                </div>
                                ...
                                <div className="mt-4 space-y-2 border-t border-gray-100 pt-4 text-xs">
                                    ...
                                    <div className="flex items-center justify-between border-t border-dashed border-gray-200 pt-2 text-sm font-extrabold text-gray-900">
                                ...
                                {selectedInvoice.status !== 'lunas' ? (
                                    <div className="mt-5 space-y-4 rounded-xl border border-[#d1fae5] bg-[#f0faf7] p-4">
                                        <div>
                                            <label className="mb-1.5 block text-xs font-bold text-[#0d4f42]">
                                                METODE PEMBAYARAN
                                            </label>
                                            ...
                                            <div className="space-y-2 border-t border-teal-200/60 pt-3">
                                                ...
                                                <div className="flex gap-1.5 pt-1">
                                                    <button
                                                        ...
                                                        onClick={() =>
                                                            setNominalInput(
                                                                selectedInvoice.total_tagihan.toString(),
                                                            )
                                                        }
                                                ...
                                                {/* Calculated Change */}
                                                <div className="mt-2 flex items-center justify-between rounded-lg bg-emerald-100/70 p-2.5 text-xs font-bold text-emerald-900">
                                                    <span>Kembalian:</span>
                                    ...
                                    <div className="mt-5 space-y-1 rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-xs">
                                        ...
                                        <p className="font-medium text-gray-600">
                                            Metode:{' '}
                                            <b>
                                                {selectedInvoice.metode_pembayaran ||
                                                    'Tunai'}
                                            </b>
                                        </p>
                                        {selectedInvoice.jumlah_dibayar > 0 && (
                                            <p className="text-gray-600">
                                                Dibayar:{' '}
                                                {formatRupiah(
                                                    selectedInvoice.jumlah_dibayar,
                                                )}{' '}
                                                • Kembalian:{' '}
                                                {formatRupiah(
                                                    selectedInvoice.kembalian,
                                                )}
                                            </p>
                                        )}
                                    </div>
                            ...
                            <div className="space-y-2 pt-2">
                                {selectedInvoice.status !== 'lunas' ? (
                                    <button
                                        ...
                                        className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#0d4f42] py-3 text-xs font-extrabold text-white shadow-sm transition-colors hover:bg-[#08382f] disabled:opacity-50"
                                    >
                                        {isProcessing ? (
                                    ...
                                    <button
                                        ...
                                        className="flex w-full items-center justify-center gap-2 rounded-xl bg-teal-800 py-3 text-xs font-extrabold text-white shadow-sm transition-colors hover:bg-teal-900"
                                    >
                                        <svg
                                            className="h-4 w-4"
                                            fill="none"
                        ...
                        <div className="w-full max-w-md space-y-4 rounded-2xl bg-white p-6 shadow-2xl">
                            <div className="border-b border-gray-200 pb-4 text-center">
                                ...
                                <p className="text-[11px] font-medium text-gray-500">
                                    Jl. Sentosa Medika No. 88, Jakarta • Telp:
                                    (021) 555-0199
                                </p>
                                <p className="mt-2 text-xs font-extrabold tracking-wider text-gray-800">
                            ...
                            <div className="space-y-1 text-xs text-gray-700">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-semibold">
                                        {selectedInvoice.waktu_pembayaran
                                            ? new Date(
                                                  selectedInvoice.waktu_pembayaran,
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-bold">
                                        {selectedInvoice.nama_pasien} (RM:{' '}
                                        {selectedInvoice.no_rm || '-'})
                                    </span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-gray-500">
                            ...
                            <div className="space-y-2 border-t border-b border-dashed border-gray-300 py-3">
                                ...
                                {selectedInvoice.rincian &&
                                    selectedInvoice.rincian.map((item, idx) => (
                                        <div
                                            key={idx}
                                            className="flex justify-between text-xs font-medium text-gray-800"
                                        >
                            ...
                            <div className="flex items-center justify-between border-t border-gray-100 pt-3 text-[11px] text-gray-400 italic">
                                <span>
                                    Petugas Kasir:{' '}
                                    {user?.nama_lengkap || 'Kasir Sentosa'}
                                </span>
                                <span className="rounded border border-emerald-300 px-2 py-0.5 font-bold text-emerald-700 not-italic">
                                    STATUS: LUNAS
                                </span>
                            </div>
                            ...
                            <div className="flex items-center justify-end gap-2 border-t border-gray-100 pt-3">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1.5 rounded-xl bg-teal-800 px-5 py-2 text-xs font-bold text-white shadow-sm hover:bg-teal-900"
                                >
                                    <svg
                                        className="h-4 w-4"
                                        fill="none"
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <select
                                        value={layananInput}
                                        onChange={(e) =>
                                            setLayananInput(e.target.value)
                                        }
                                        className="w-full rounded-xl border border-gray-300 p-2.5 text-xs font-semibold focus:border-teal-700 focus:outline-none"
                                    >
                                        ...
                                        <option value="IGD (Gawat Darurat)">
                                            IGD (Gawat Darurat)
                                        </option>
                                        ...
                                        <option value="Rawat Inap - Bangsal Mawar">
                                            Rawat Inap - Bangsal Mawar
                                        </option>
                                        <option value="Farmasi & Resep Obat">
                                            Farmasi & Resep Obat
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div className="space-y-2 border-t border-gray-100 pt-3">
                                    ...
                                    {rincianItems.map((item, idx) => (
                                        <div
                                            key={idx}
                                            className="grid grid-cols-12 items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 p-2.5"
                                        >
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        value={catatanInput}
                                        onChange={(e) =>
                                            setCatatanInput(e.target.value)
                                        }
                ...
                <div className="rounded-xl border border-gray-200 bg-[#d1fae5]/20 p-6">
                    <div className="mb-4 flex items-start justify-between">
                        ...
                        <span className="flex items-center gap-1 rounded-full bg-red-100 px-3 py-1 text-xs font-bold text-red-700">
                            ...
                            {prjPerluPerhatian} Perlu Perhatian
                        </span>
                    </div>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm lg:col-span-3">
                    <div className="mb-6 flex items-center justify-between border-b border-gray-100 pb-4">
                        ...
                        <Link
                            href="/jadwal-shift"
                            className="flex items-center gap-1 text-sm font-bold text-[#0d4f42]"
                        >
                            Lihat Semua{' '}
                        ...
                        {[
                            {
                                ...
                                href: '/jadwal-shift',
                                icon: (
                                    <i className="fa-solid fa-calendar-days text-lg text-teal-700"></i>
                                ),
                            },
                            {
                                ...
                                icon: (
                                    <i className="fa-solid fa-user-plus text-lg text-teal-700"></i>
                                ),
                            },
                            {
                                ...
                                href: '/rme',
                                icon: (
                                    <i className="fa-solid fa-file-medical text-lg text-teal-700"></i>
                                ),
                            },
                        ].map((a, idx) => (
                            <Link
    ...
    const DoctorDashboard = () => {
        const nextPatient =
            dktAntrianHariIni.find(
                (a) =>
                    a.status === 'menunggu' || a.status === 'sedang_dilayani',
            ) || dktAntrianHariIni[0];
                        ...
                        {nextPatient ? (
                            <>
                                ...
                                <button className="mt-8 flex w-fit items-center gap-2 rounded-lg bg-[#0d4f42] px-6 py-3 text-sm font-bold text-white shadow-sm hover:bg-[#0a3d33]">
                                    ...
                                    Mulai Konsultasi Pasien Berikutnya
                                </button>
                            </>
                        ) : (
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                        ...
                        {dktAntrianHariIni.length > 0 ? (
                            <p className="text-sm text-gray-600">
                                Ada {dktAntrianHariIni.length} pasien dalam
                                daftar praktik Anda hari ini. Pastikan untuk
                                mengecek rekam medis sebelum memulai konsultasi.
                            </p>
                        ) : (
                            <p className="text-sm text-gray-500">
    ...
    const PharmacistDashboard = () => {
        ...
        const [statusFilter, setStatusFilter] = useState<
            'semua' | 'menunggu_ditebus' | 'sudah_ditebus'
        >('semua');
        ...
        const [isPengeluaranSubmitting, setIsPengeluaranSubmitting] =
            useState(false);
        ...
        const filteredObats = aptObatMasterList.filter((o: any) => {
            return (
                (o.nama_obat || '')
                    .toLowerCase()
                    .includes(searchObat.toLowerCase()) ||
                (o.kode_obat || '')
                    .toLowerCase()
                    .includes(searchObat.toLowerCase()) ||
                (o.bentuk_sediaan || '')
        ...
        const handleSavePengeluaran = (e: React.FormEvent) => {
            ...
            const targetObat = aptObatMasterList.find(
                (o: any) => o.id === pengeluaranData.obat_id,
            );
            if (!targetObat) return;

            const newStok = Math.max(
                0,
                targetObat.stok - Number(pengeluaranData.jumlah),
            );
            ...
            router.post(
                ...
                {
                    stok: newStok,
                    alasan: `Pengeluaran Stok: ${pengeluaranData.alasan}`,
                },
                {
                    onFinish: () => {
            ...
            <div className="space-y-6">
                <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p className="text-xs text-gray-500">
                            Penerbitan, penebusan resep digital real-time, dan
                            manajemen stok obat SIMRS.
                        </p>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-xs">
                        ...
                        <div className="flex justify-between text-xs text-gray-600">
                            <div className="flex flex-col items-center gap-0.5 rounded-md border border-yellow-200 bg-yellow-50 px-2.5 py-1 text-yellow-700">
                            ...
                            <div className="flex flex-col items-center gap-0.5 rounded-md border border-orange-200 bg-orange-50 px-2.5 py-1 text-orange-700">
                                <span className="text-[10px] font-semibold">
                                    Disiapkan
                                </span>
                                <span className="text-base font-bold">
                            ...
                            <div className="flex flex-col items-center gap-0.5 rounded-md border border-emerald-200 bg-emerald-50 px-2.5 py-1 text-emerald-700">
                                <span className="text-[10px] font-semibold">
                                    Selesai
                                </span>
                                <span className="text-base font-bold">
                    ...
                    <div className="flex flex-col justify-between rounded-xl border border-gray-200 bg-white p-6 shadow-xs">
                        <div>
                        ...
                        <div className="flex h-16 items-end justify-between gap-1.5 pt-2">
                            {aptWeeklyTransactions.map(
                                (wt: any, idx: number) => {
                                    ...
                                    const heightPercent = Math.max(
                                        15,
                                        Math.round((wt.count / maxCount) * 100),
                                    );
                                    return (
                                        <div
                                            key={idx}
                ...
                <div className="flex flex-wrap gap-3">
                    <button
                        ...
                        className="flex items-center gap-2 rounded-xl bg-[#0d4f42] px-5 py-2.5 text-xs font-bold text-white shadow-xs transition-all hover:bg-[#093a31]"
                    >
                        <svg
                            className="h-4 w-4"
                            fill="none"
                    ...
                    <button
                        onClick={() => setShowStokModal(true)}
                        className="flex items-center gap-2 rounded-xl border border-[#0d4f42]/20 bg-emerald-50 px-5 py-2.5 text-xs font-bold text-[#0d4f42] transition-all hover:bg-emerald-100"
                    >
                        <svg
                            className="h-4 w-4"
                            fill="none"
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 rounded-xl border border-gray-300 bg-white px-5 py-2.5 text-xs font-bold text-gray-700 transition-all hover:bg-gray-50"
                    >
                        <svg
                            className="h-4 w-4"
                            fill="none"
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    <div className="space-y-4 rounded-xl border border-gray-200 bg-white p-6 shadow-xs lg:col-span-2">
                        <div className="flex flex-col gap-3 border-b border-gray-100 pb-4 sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                ...
                                <p className="text-xs text-gray-500">
                                    Resep diterbitkan dokter dari Rekam Medis
                                    Elektronik (RME)
                                </p>
                            </div>
                        ...
                        {filteredReseps.length === 0 ? (
                            <div className="py-12 text-center">
                                <p className="text-sm text-gray-500">
                                    Tidak ada resep digital yang sesuai kriteria
                                    pencarian.
                                </p>
                            </div>
                        ) : (
                            <div className="overflow-x-auto">
                                <table className="w-full text-left text-sm">
                                    <thead className="border-b border-gray-100 bg-gray-50/50 text-xs font-semibold text-gray-500 uppercase">
                                        <tr>
                                        ...
                                        {filteredReseps.map((r: any) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-3 py-3">
                                                    ...
                                                    >
                                                        <span
                                                            className={`h-1.5 w-1.5 rounded-full ${r.status === 'sudah_ditebus' ? 'bg-emerald-500' : 'bg-amber-500'}`}
                                                        ></span>
                                                        {r.status ===
                                                        'sudah_ditebus'
                                                            ? 'Sudah Ditebus'
                                                ...
                                                <td className="px-3 py-3 text-right">
                                                    <button
                                                        ...
                                                        className={`rounded-lg px-3 py-1.5 text-xs font-bold shadow-2xs transition-all ${
                                                            r.status ===
                                                            'sudah_ditebus'
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {aptLowStockList
                                    ...
                                    .map((ob: any, idx: number) => (
                                        <div
                                            key={idx}
                                            className={`rounded-xl border p-3 text-center ${ob.level === 'habis' ? 'border-rose-200 bg-rose-50/50' : 'border-amber-200 bg-amber-50/50'}`}
                                        >
                                            <p
                                                className={`text-2xl font-bold ${ob.level === 'habis' ? 'text-rose-600' : 'text-amber-600'}`}
                                            >
                                                {ob.stok}
                                            </p>
                                ...
                                {aptLowStockList.length < 2 && (
                                    <div className="col-span-2 rounded-xl border border-emerald-200 bg-emerald-50/50 p-3 text-center">
                                        <p className="text-sm font-bold text-emerald-700">
                                            Stok obat aman & tersedia
                                        </p>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="space-y-3 rounded-xl border border-gray-200 bg-white p-5 shadow-xs">
                            ...
                            <div className="space-y-2.5 text-xs">
                                {aptRecentTransactions.length === 0 ? (
                                    <p className="text-xs text-gray-400 italic">
                                        Belum ada transaksi penebusan hari ini.
                                    </p>
                                ) : (
                                    aptRecentTransactions
                                        .slice(0, 4)
                ...
                {selectedResep && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50 p-4">
                        <div className="animate-in fade-in zoom-in-95 w-full max-w-xl space-y-5 rounded-2xl bg-white p-6 shadow-xl duration-200">
                            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                                <div>
                                    <h3 className="text-lg font-bold text-gray-900">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        No. Resep:{' '}
                                        <span className="font-bold text-[#0d4f42]">
                            ...
                            <div className="grid grid-cols-2 gap-3 rounded-xl bg-gray-50 p-3 text-xs">
                                ...
                                <div>
                                    ...
                                    <p className="font-bold text-gray-900">
                                        {selectedResep.dokter}
                                    </p>
                                </div>
                            </div>

                            <div>
                                <h4 className="mb-2 text-xs font-bold text-gray-700 uppercase">
                                    Daftar Obat Resep & Ketersediaan Stok
                                </h4>
                                                        ...
                                                        return (
                                                            <tr key={idx}>
                                                                ...
                                                                <td className="px-3 py-2.5 text-right">
                                                                    <span
                                                                        className={`font-bold ${isStokCukup ? 'text-emerald-700' : 'text-rose-600'}`}
                                                                    >
                                                                        {
                                                                            item.stok_tersedia
                                                                        }{' '}
                            ...
                            <div className="flex items-center justify-end gap-3 border-t border-gray-100 pt-4">
                                ...
                                {selectedResep.status === 'menunggu_ditebus' ? (
                                    <button
                                        ...
                                        onClick={() =>
                                            handleProcessTebus(selectedResep.id)
                                        }
                ...
                {showStokModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50 p-4">
                        <div className="animate-in fade-in zoom-in-95 flex max-h-[90vh] w-full max-w-4xl flex-col space-y-4 rounded-2xl bg-white p-6 shadow-xl duration-200">
                            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                                <div>
                                    <h3 className="text-lg font-bold text-gray-900">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        Kelola kuantitas stok, harga, dan produk
                                        obat di database SIMRS.
                                    </p>
                                </div>
                                <div className="flex items-center gap-2">
                                    <button
                ...
                {editingObat && (
                    <div className="fixed inset-0 z-60 flex items-center justify-center bg-gray-900/60 p-4">
                        ...
                        >
                            <h3 className="border-b border-gray-100 pb-2 text-lg font-bold text-gray-900">
                                Update Stok Obat
                            </h3>
                            <div>
                                <p className="text-xs text-gray-500">
                                ...
                                <p className="text-sm font-bold text-[#0d4f42]">
                                    {editingObat.nama_obat} (
                                    {editingObat.kode_obat})
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value={restockAlasan}
                                    onChange={(e) =>
                                        setRestockAlasan(e.target.value)
                                    }
                        ...
                        >
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full rounded-xl border border-gray-300 px-3 py-2 text-xs focus:border-[#0d4f42] focus:outline-none"
                                >
                                    <option value="Rusak / Expired">
                                        Rusak / Expired
                                    </option>
                                    <option value="Pengeluaran Rawat Inap / IGD">
                                        Pengeluaran Rawat Inap / IGD
                                    </option>
                                    <option value="Sampel Laboratorium">
                                        Sampel Laboratorium
                                    </option>
                ...
                {showRiwayatModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50 p-4">
                        <div className="flex max-h-[85vh] w-full max-w-2xl flex-col space-y-4 rounded-2xl bg-white p-6 shadow-xl">
                            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                                <div>
                                    <h3 className="text-lg font-bold text-gray-900">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        Daftar transaksi penebusan obat yang
                                ...
                                <table className="w-full text-left text-xs">
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                        {aptRecentTransactions.length === 0 ? (
                                            ...
                                            aptRecentTransactions.map(
                                                (t: any, idx: number) => (
                                                    <tr
                                                        key={idx}
                                                        className="hover:bg-gray-50"
                                                    >
                                                        <td className="px-3 py-2.5 font-bold text-[#0d4f42]">
                                                            {t.no_resep}
                                                        </td>
                                                        <td className="px-3 py-2.5 font-semibold text-gray-800">
                                                            {t.nama_pasien}
    ...
    const ManajemenDashboard = () => {
        const maxChartCount = Math.max(
            ...mgtWeeklyTransactions.map((t) => t.count),
            1,
        );
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-xs">
                        ...
                        <div className="mb-5">
                            <span className="font-serif text-5xl font-bold text-[#0d4f42]">
                                {mgtTodayReseps}
                            </span>
                            <span className="ml-2 text-base font-semibold text-[#0d4f42]">
                                Resep
                            </span>
                        </div>
                    ...
                    <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-xs">
                        ...
                        {mgtLowStockList.length > 0 ? (
                            <div className="space-y-2.5">
                                {mgtLowStockList.slice(0, 3).map((item) => (
                                    ...
                                    >
                                        <span
                                            className="max-w-[160px] truncate text-sm text-gray-800"
                                            title={item.nama}
                                        >
                                            {item.nama}
                                        </span>
                        ...
                        <Link
                            href="/rme"
                            className="mt-4 block text-center text-xs font-bold tracking-widest text-[#145e5b] uppercase hover:underline"
                        >
                            Lihat Semua Stok
                        </Link>
                    </div>
                    ...
                    <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-xs">
                        ...
                        <div className="mb-4">
                            <span className="font-serif text-4xl font-bold text-[#0d4f42]">
                                {mgtTodayProcessed}
                            </span>
                                ...
                                const heightPercent =
                                    maxChartCount > 0
                                        ? Math.max(
                                              8,
                                              Math.round(
                                                  (t.count / maxChartCount) *
                                                      100,
                                              ),
                                          )
                                        : 8;
                                const isToday =
                                    idx === mgtWeeklyTransactions.length - 1;
                                return (
                                    <div
                                        key={idx}
                ...
                <div className="grid grid-cols-1 gap-5 lg:grid-cols-12">
                    ...
                    <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-xs lg:col-span-8">
                        ...
                        {mgtPrescriptionQueue.length > 0 ? (
                            <div className="overflow-x-auto">
                                <table className="w-full text-left text-sm">
                                    <thead>
                                        <tr className="border-b border-gray-200 text-xs font-semibold tracking-wider text-gray-500 uppercase">
                                            ...
                                            <th className="pr-4 pb-3 text-center">
                                                Jumlah Item
                                            </th>
                                            ...
                                            .map((item) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="py-3 text-center">
                                                        <span
                                                            className={`inline-block rounded-full px-2.5 py-0.5 text-[10px] font-bold ${getStatusStyle(item.status)}`}
                                                        >
                                                            {getStatusLabel(
                                                                item.status,
                                                            )}
                    ...
                    <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-xs lg:col-span-4">
                        <h3 className="mb-5 font-serif text-lg font-bold text-gray-900">
                            Riwayat Terakhir
                        </h3>
                        ...
                        {mgtRecentTransactions.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-8 text-center">
                                <svg
                                    className="mb-2 h-10 w-10 text-gray-200"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    strokeWidth={1.5}
    ...
    const ReceptionistDashboard = () => {
        ...
        return (
            <div className="-m-4 min-h-[calc(100vh-5rem)] space-y-6 rounded-2xl bg-[#f0f7f5] p-4 sm:-m-6 sm:space-y-8 sm:p-8">
                ...
                <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        ...
                        <h1 className="mt-1 font-serif text-3xl font-normal tracking-tight text-[#1e293b] sm:text-4xl">
                    ...
                    <div>
                        <button
                            ...
                            className="inline-flex cursor-pointer items-center gap-2.5 rounded-xl bg-[#0f685c] px-5 py-3 text-sm font-semibold text-white shadow-xs transition-all hover:bg-[#0b5349] active:scale-95"
                        >
                            <svg
                                className="h-5 w-5"
                                fill="none"
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                    ...
                    <div className="flex h-40 flex-col justify-between rounded-2xl border border-gray-100/80 bg-white p-6 shadow-xs transition-shadow hover:shadow-md">
                        <div className="flex items-center justify-between">
                    ...
                    <div className="flex h-40 flex-col justify-between rounded-2xl border border-gray-100/80 bg-white p-6 shadow-xs transition-shadow hover:shadow-md">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="inline-flex items-center gap-1.5 rounded-full bg-[#d7f2ec]/60 px-3.5 py-1 text-xs font-semibold text-[#0f685c]">
                                <span className="h-2 w-2 animate-pulse rounded-full bg-[#0f685c]"></span>
                                Live
                            </span>
                        </div>
                        <div>
                            ...
                            <p className="mt-0.5 text-3xl font-extrabold tracking-tight text-[#0f685c]">
                                {rcpActiveQueue}
                            </p>
                        </div>
                    </div>
                ...
                <div className="overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-xs">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full border-collapse text-left">
                            <thead>
                                <tr className="border-b border-gray-100 bg-[#f8faf9] text-[11px] font-bold tracking-wider text-gray-500 uppercase">
                            ...
                            <tbody className="divide-y divide-gray-100 text-sm">
                                ...
                                {queueList.map((item, idx) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <td className="px-6 py-4 font-bold tracking-wide text-gray-900">
                                                {item.nomor_antrian}
                                            </td>
